    ...
    <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 py-10" style={{ paddingLeft: 'calc(280px + 1.5rem)' }}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-12">
        <div className="bg-white rounded-2xl p-7 shadow-card hover:shadow-card-hover transition-shadow">
          ...
          <p className={`text-4xl font-medium tracking-tight ${netWorth >= 0 ? 'text-black' : 'text-red-600'}`}>
            {formatCurrency(netWorth)}
          </p>
        </div>
        <div className="bg-white rounded-2xl p-7 shadow-card hover:shadow-card-hover transition-shadow">
          <p className="text-sm font-medium text-gray-500 mb-3 uppercase tracking-wide">Total Assets</p>
          <p className="text-4xl font-medium tracking-tight text-black">{formatCurrency(totalAssets)}</p>
        </div>
        <div className="bg-white rounded-2xl p-7 shadow-card hover:shadow-card-hover transition-shadow">
          <p className="text-sm font-medium text-gray-500 mb-3 uppercase tracking-wide">Total Liabilities</p>
          <p className="text-4xl font-medium tracking-tight text-black">{formatCurrency(totalLiabilities)}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-card overflow-hidden">
            {recentTransactions.length === 0 ? (
              <div className="p-12 text-center">
                ...
                <Link 
                  href="/transactions" 
                  className="text-sm font-medium text-black hover:text-gray-700 transition-colors inline-block"
                >
                  ...
                  <div key={transaction.id} className="p-5 hover:bg-gray-50 transition-colors group">
                    <div className="flex items-center justify-between">
                      <div className="flex-1 min-w-0">
                        <p className="font-medium text-black mb-1">{transaction.description}</p>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              <p className="font-medium text-black mb-1.5 group-hover:text-gray-700">Add Asset</p>
            ...
            <Link 
              ...
              className="bg-white rounded-2xl p-6 shadow-card hover:shadow-card-hover transition-all group"
            >
              <p className="font-medium text-black mb-1.5 group-hover:text-gray-700">Add Liability</p>
            ...
            <Link 
              ...
              className="bg-white rounded-2xl p-6 shadow-card hover:shadow-card-hover transition-all group"
            >
              <p className="font-medium text-black mb-1.5 group-hover:text-gray-700">Add Transaction</p>
            ...
            <Link 
              ...
              className="bg-white rounded-2xl p-6 shadow-card hover:shadow-card-hover transition-all group"
            >
              <p className="font-medium text-black mb-1.5 group-hover:text-gray-700">View Cash Flow</p>
